...
const s = {
  ...
  hero: { background: "linear-gradient(135deg, #1a3f4c, #1F4E5C, #2A7F8F)", padding: "48px 40px", textAlign: "center" },
  ...
  heroTitle: { color: "#fff", fontSize: "clamp(26px, 4vw, 40px)", fontWeight: "900", marginBottom: "12px" },
  heroSub: { color: "#cde8ec", fontSize: "16px", maxWidth: "560px", margin: "0 auto", lineHeight: 1.7 },
  layout: { display: "grid", gridTemplateColumns: "1fr 340px", gap: "24px", maxWidth: "1200px", margin: "0 auto", padding: "32px 24px", alignItems: "start" },
  ...
  messages: { padding: "24px", display: "flex", flexDirection: "column", gap: "20px", minHeight: "480px", maxHeight: "560px", overflowY: "auto" },
  assistantRow: { display: "flex", gap: "12px", alignItems: "flex-start" },
  userRow: { display: "flex", gap: "12px", alignItems: "flex-start", justifyContent: "flex-end" },
  avatar: { fontSize: "28px", flexShrink: 0, marginTop: "2px" },
  userAvatar: { fontSize: "28px", flexShrink: 0, marginTop: "2px" },
  assistantBubble: { background: "#f7fafb", borderRadius: "0 12px 12px 12px", padding: "16px 18px", maxWidth: "80%", border: "1px solid #e8eef0" },
  userBubble: { background: "#1F4E5C", borderRadius: "12px 0 12px 12px", padding: "14px 18px", maxWidth: "75%" },
  answerText: { color: "#333", fontSize: "14px", lineHeight: 1.7, margin: 0 },
  userText: { color: "#fff", fontSize: "14px", lineHeight: 1.6, margin: 0 },
  productTag: { display: "flex", alignItems: "center", gap: "8px", flexWrap: "wrap", background: "#EAF2F3", borderRadius: "8px", padding: "8px 12px", marginTop: "12px", fontSize: "14px", color: "#1F4E5C" },
  ...
  inputRow: { display: "flex", gap: "12px", padding: "16px 20px", borderTop: "1px solid #eee", background: "#fafafa" },
  input: { flex: 1, border: "2px solid #e0e0e0", borderRadius: "10px", padding: "12px 16px", fontSize: "14px", resize: "none", fontFamily: "inherit", outline: "none", lineHeight: 1.5, cursor: "text" },
  sendBtn: { background: "#1F4E5C", color: "#fff", border: "none", borderRadius: "10px", padding: "12px 20px", fontWeight: "700", fontSize: "14px", cursor: "pointer", whiteSpace: "nowrap", alignSelf: "flex-end" },
  ...
  suggestion: { background: "#f7fafb", border: "1px solid #e0e8ea", borderRadius: "8px", padding: "10px 12px", fontSize: "13px", color: "#333", cursor: "pointer", textAlign: "left", lineHeight: 1.4, transition: "background 0.2s" },
